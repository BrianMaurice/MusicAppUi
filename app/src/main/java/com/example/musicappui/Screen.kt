...
sealed class Screen (val title: String, val route: String) {
    ...
    sealed class BottomScreen(
        val bTitle: String, val bRoute: String, @DrawableRes val iconResId: Int
    ...
    sealed class DrawerScreen(val dTitle: String, val dRoute: String, @DrawableRes val iconResId: Int)
