...
fun MainView() {
                ...
                screensInBottom.forEach {
                    ...
                    BottomNavigationItem(selected = currentRoute == item.bRoute,
                        onClick = {controller.navigate(item.bRoute)
                            ...
                            Icon(tint = tint, contentDescription = item.bTitle, painter = painterResource(id = item.iconResId))
                        },
                        label = {
    ...
    ModalBottomSheetLayout(
        ...
        Scaffold (
            ...
            drawerContent = {LazyColumn(Modifier.padding(16.dp)){
...
fun DrawerItem(
    ...
    Row (Modifier.fillMaxWidth()
        ...
        Icon(painter = painterResource(id=item.iconResId),
...
fun Navigation(viewModel: MainViewModel = viewModel(),
               navController: NavController, pd: PaddingValues
){
    NavHost (
